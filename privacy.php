...
?>
     <section class=" mt-5">
            <p class="w-75 fw-bold">
                This Privacy Policy describes how techshop.000webhost.com (the “Site” or
                “we”) collects, uses, and discloses your Personal Information when
                you visit or make a purchase from the Site.
            </p>

            <h3 class="fs-2 fw-bold">Collecting Personal Information</h3>
           ...
           <h5 class="fs-4 fw-bold mt-3">Device information</h5>
            ...
            <p class="text-muted lh-lg">
             ...
             <h5 class="fs-4 fw-bold mt-3">Customer support information</h5>

            <p class="text-muted lh-lg">
                Examples of Personal Information collected: The Forms That Appear On Our Contact Page Is All The information We Collect About You
